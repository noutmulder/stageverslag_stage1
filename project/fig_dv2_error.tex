...
\node[red,font=\scriptsize,below right] at (0.05,0.657) {$-10$\,mm pre-registered limit ($>$5\,m rail)};
...
\node[font=\small] at (3.70,-0.85) {Position along rail $d_{\mathrm{phys}}$ (mm)};
\node[font=\small,rotate=90] at (-0.95,2.30) {Display minus physical (mm)};
\end{tikzpicture}%
}
