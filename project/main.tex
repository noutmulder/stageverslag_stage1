...
The path from a raw Bluetooth byte to a moving 3D chair on screen passes
through five processing stages. Each stage has a single responsibility: receive
...
The tangent (direction of travel) at the current position is computed using
the surrounding control points~\cite{catmullrom1974} $\mathbf{p}_0 \ldots \mathbf{p}_3$:
\begin{equation}
