...
code. Because this choice fixes the input parameters for the rendering layer
of the pipeline architecture (Section~\ref{sec:results-q2}), it is part of the
vooronderzoek~\cite{gielingartikel2223}. Four candidate engines were compared
against four criteria: (C1) configurability
...
needed for the custom shaders required by the renderer layer; and its glTF
binary import handles the multi-mesh chair model without a format conversion
step. Unreal was excluded
