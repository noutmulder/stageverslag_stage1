...
\begin{enumerate}[leftmargin=*]
  \item \textit{Which fault types and status indicators from the stairlift
    ...
    The firmware produces over 168 message types. Before any visualization can
...
\textbf{Fault types.}
The classification of 168 firmware message types revealed that only six carry
